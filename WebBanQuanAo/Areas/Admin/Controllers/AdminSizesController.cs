...
namespace WebBanQuanAo.Areas.Admin.Controllers
{
    ...
    public class AdminSizesController : Controller
    {
        ...
        public AdminSizesController(db_ClothingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SizeId,SizeName,Description")] Size size)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SizeId,SizeName,Description")] Size size)
        {
            if (id != size.SizeId)
            {
                return NotFound();

...
namespace WebBanQuanAo
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<db_ClothingContext>(options => options.UseSqlServer(Configuration.GetConnectionString("db_Clothing")));
            ...
            services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
                .AddCookie(p =>
                {
                    ...
                    p.AccessDeniedPath = $"/Admin/Login/AccessDenied";
                });
